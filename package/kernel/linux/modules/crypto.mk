...
define KernelPackage/crypto-chacha20
  TITLE:=ChaCha20 skcipher for the crypto API (6.18+: crypto/chacha.ko)
  DEPENDS:=@!LINUX_6_12 +kmod-crypto-lib-chacha20
  KCONFIG:=CONFIG_CRYPTO_CHACHA20
  FILES:=$(LINUX_DIR)/crypto/chacha.ko
  AUTOLOAD:=$(call AutoLoad,09,chacha)
  $(call AddDepends/crypto)
endef
...
define KernelPackage/crypto-chacha20poly1305
  ...
  DEPENDS:=+kmod-crypto-aead +kmod-crypto-manager +!LINUX_6_12:kmod-crypto-lib-poly1305 +!LINUX_6_12:kmod-crypto-chacha20
...
define KernelPackage/crypto-test
  ...
  KCONFIG:=CONFIG_CRYPTO_TEST CONFIG_CRYPTO_BENCHMARK
